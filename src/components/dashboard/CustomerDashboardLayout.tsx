...
const customerNavItems = [
  ...
  { icon: Upload, label: 'New Request', href: '/dashboard/new-request' },
  { icon: ClipboardList, label: 'My Orders', href: '/dashboard/orders' },
  { icon: MessageSquare, label: 'Messages', href: '/dashboard/messages' },
  { icon: Leaf, label: 'My Impact', href: '/dashboard/impact' },
  { icon: Settings, label: 'Settings', href: '/dashboard/settings' },
];

export function CustomerDashboardLayout({ children, title, subtitle }: DashboardLayoutProps) {
