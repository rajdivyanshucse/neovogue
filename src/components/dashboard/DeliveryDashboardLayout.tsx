...
const deliveryNavItems = [
  ...
  { icon: Truck, label: 'Active Deliveries', href: '/delivery/active' },
...
export function DeliveryDashboardLayout({ children, title, subtitle }: DashboardLayoutProps) {
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-sidebar-border">
            ...
            <span className="text-xs text-sidebar-foreground/60 mt-1 block">Delivery Partner</span>
          </div>
          ...
          <div className="p-4 border-t border-sidebar-border">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-sidebar-foreground/60">Delivery Partner</p>
              </div>
            </div>
            <Button
              variant="ghost"
